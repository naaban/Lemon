...
class CapacitorCommand extends command_1.Command {
    ...
    _runCapacitor(argList) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const { root: cwd } = yield this.project.getIntegration('capacitor');
            yield this.env.shell.run('capacitor', argList, { fatalOnNotFound: false, truncateErrorOutput: 5000, stdio: 'inherit', cwd });
        });
    }
}
